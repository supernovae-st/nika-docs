...
```bash
# export needs the journal path (the run card's `trace:` line, or `nika trace ls`)
nika trace export .nika/traces/2026-07-28T06-58-44Z-bb6e.ndjson
# → .nika/traces/2026-07-28T06-58-44Z-bb6e.otlp.jsonl  (one OTLP span per line)

nika trace export .nika/traces/2026-07-28T06-58-44Z-bb6e.ndjson -o run.otlp.jsonl
```
