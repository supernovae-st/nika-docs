...
semantic spec compile to an SVG that is **byte-identical forever** for
identical inputs, and the artifact's sha256 joins the run's hash-chained
trace. Rehearse any surrounding infer with `mock/echo`; this builtin
