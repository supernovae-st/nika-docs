...
they fire on success, failure, timeout and cancel alike. A pipeline
that only reports when it succeeds can't be trusted at 3am.
...
- id: digest
  ...
  invoke:
    ...
    args:
      ...
      query: "[ .[] | select(. != null) ]"   # the survivors · order preserved
```
...
- id: build_matrix
  invoke:
    ...
    args:
      ...
      query: "[ .os[] as $o | .ver[] as $v | {os: $o, ver: $v} ]"
