...
workflow:
  id: kebab-case-name     # resource name
  description: "…"              # one honest sentence

model: mock/echo              # mock-first · sovereignty is one line away

inputs:                       # typed · what the CALLER supplies · required: true documents itself
config:                       # typed · the DEPLOYMENT's dials · may appear in logs
