...
<Info>
  ...
  These blocks are that projection again (2026-08-19 · spec
  `f308fa32e` · the released 0.109 grammar, `NIKA_SERVED_GRAMMAR=wnew`):
  what you copy here is byte-for-byte what `nika new <template>` writes.
</Info>
