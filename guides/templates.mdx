...
tasks:
  ...
  persist:
    ...
    invoke:
      tool: "nika:write"
      args:
        path: "${{ vars.destination }}"   # SLOT: destination · same path as permits.fs.write
...
tasks:
  ...
  approve:
    invoke:
      tool: "nika:prompt"
      args:
        message: "Fetch ${{ vars.source_url }} and persist it into ${{ vars.state_path }}?"
...
tasks:
  create:
    invoke:
      tool: "nika:fetch"
      args:
        url: "${{ vars.api_base }}/items"   # SLOT: the create endpoint
        method: POST
        headers:
