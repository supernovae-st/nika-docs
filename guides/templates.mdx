...
{/* template:begin chain.nika */}
```yaml chain.nika skeleton
...
{/* template:begin gate-and-act.nika */}
```yaml gate-and-act.nika skeleton
...
{/* template:begin fanout.nika */}
```yaml fanout.nika skeleton
...
{/* template:begin etl-state.nika */}
```yaml etl-state.nika skeleton
...
{/* template:begin agent-loop.nika */}
```yaml agent-loop.nika skeleton
...
{/* template:begin human-gated-ship.nika */}
```yaml human-gated-ship.nika skeleton
...
{/* template:begin website-brief.nika */}
```yaml website-brief.nika skeleton
...
{/* template:begin media-asset-pack.nika */}
```yaml media-asset-pack.nika skeleton
...
{/* template:begin api-upload-and-create.nika */}
```yaml api-upload-and-create.nika skeleton
...
{/* template:begin docker-report.nika */}
```yaml docker-report.nika skeleton
...
{/* template:begin aggregate-by-key.nika */}
```yaml aggregate-by-key.nika skeleton
...
{/* template:begin bounded-batch.nika */}
```yaml bounded-batch.nika skeleton
nika: bounded-batch
...
{/* template:begin classify-and-route.nika */}
```yaml classify-and-route.nika skeleton
...
{/* template:begin corpus-qa.nika */}
```yaml corpus-qa.nika skeleton
...
{/* template:begin deduplicate-records.nika */}
```yaml deduplicate-records.nika skeleton
...
{/* template:begin document-to-fields.nika */}
```yaml document-to-fields.nika skeleton
...
{/* template:begin evaluate-and-optimize.nika */}
```yaml evaluate-and-optimize.nika skeleton
...
{/* template:begin parallel-review.nika */}
```yaml parallel-review.nika skeleton
...
{/* template:begin project-public-fields.nika */}
```yaml project-public-fields.nika skeleton
...
{/* template:begin recover-optional-file.nika */}
```yaml recover-optional-file.nika skeleton
...
{/* template:begin snapshot-diff.nika */}
```yaml snapshot-diff.nika skeleton
nika: snapshot-diff
const:
...
{/* template:begin validate-records.nika */}
```yaml validate-records.nika skeleton
