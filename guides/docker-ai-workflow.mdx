...
Checked clean against `nika 0.120.1` (`9d554c84c` · `nika check` exit 0 ·
permits declared · 0 hints). The run card below is a dated capture from
2026-07-08; re-run on your machine for a current journal:
...
```bash
nika run docker-health-report.nika
```
