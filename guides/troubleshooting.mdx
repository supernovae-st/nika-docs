...
<AccordionGroup>
  <Accordion title="Can I run Nika today?" icon="play">
    Not yet — the engine is mid-rebuild (Diamond). The **first public
    release is 1.0.0** (language v1 + a vertical slice you can launch),
    1 Aug 2026. What works today: the JSON schema validates your
