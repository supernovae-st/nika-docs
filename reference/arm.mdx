...
|---|---|---|
| `workflow` | yes | The workflow to fire — a repo-relative `*.nika` path |
...
2 beats in /home/alice/project/nika.yaml
  ...
  [armed] workflows/nightly-report.nika · TZ=Europe/Paris 30 7 * * *
  ...
  [armed] workflows/on-event.nika · on-webhook
...
is the workflow file's radical (`workflows/doctor.nika` → `doctor`;
