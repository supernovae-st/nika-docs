...
<CardGroup cols={2}>
  ...
  <Card title="Check a reference" icon="file-contract" href="/reference/knowledge-system">
    Understand source versions and the difference between a contract and an implementation.
  </Card>
</CardGroup>
...
Use the current documentation destination when following an older bookmark. For
example, the reference formerly at `/language/stdlib/assert` is now
