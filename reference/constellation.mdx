...
## Memory subsystem (the Connectome era): separate count

The 8-crate memory subsystem (plus 1 orchestrator at L2) is **not counted**
in the {STATUS.cratesTarget} target. It lands in the Connectome era (the next major, un-numbered until declared),
