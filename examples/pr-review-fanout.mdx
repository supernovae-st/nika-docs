...
```mermaid
flowchart LR
  changed["changed · git diff"]:::exec --> files["files · jq split"]:::invoke
  files --> reviews["reviews · for_each agent ×N"]:::agent
  todo["todo_sweep · nika:grep"]:::invoke --> summary["summary"]:::infer
  reviews --> merged["merged · jq flatten"]:::invoke
  merged --> summary
  summary --> save["save · REVIEW.md"]:::invoke
