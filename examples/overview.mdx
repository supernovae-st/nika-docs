...
| Construct | Taught by |
|---|---|
| [fan-out over a collection](/concepts/workflows) | [bookmark-triage](/examples/bookmark-triage) · [competitor-radar](/examples/competitor-radar) · [image-fx-batch](/examples/image-fx-batch) · [localization-factory](/examples/localization-factory) · [pr-review-fanout](/examples/pr-review-fanout) · [resume-screener](/examples/resume-screener) |
| [bounded concurrency](/concepts/workflows) | [bookmark-triage](/examples/bookmark-triage) · [competitor-radar](/examples/competitor-radar) · [image-fx-batch](/examples/image-fx-batch) · [localization-factory](/examples/localization-factory) · [pr-review-fanout](/examples/pr-review-fanout) · [resume-screener](/examples/resume-screener) |
...
| [typed workflow outputs (callable)](/reference/yaml-syntax) | [bookmark-triage](/examples/bookmark-triage) · [ceo-monday-brief](/examples/ceo-monday-brief) · [competitor-radar](/examples/competitor-radar) · [config-drift-sentinel](/examples/config-drift-sentinel) · [contract-guard](/examples/contract-guard) · [csv-chart-report](/examples/csv-chart-report) · [deep-research-brief](/examples/deep-research-brief) · [etl-quarantine](/examples/etl-quarantine) · [image-fx-batch](/examples/image-fx-batch) · [incident-war-room](/examples/incident-war-room) · [invoice-chaser](/examples/invoice-chaser) · [localization-factory](/examples/localization-factory) · [meeting-actions](/examples/meeting-actions) · [model-bench](/examples/model-bench) · [og-images](/examples/og-images) · [pr-review-fanout](/examples/pr-review-fanout) · [price-watch](/examples/price-watch) · [release-notes](/examples/release-notes) · [release-radar](/examples/release-radar) · [release-train](/examples/release-train) · [resume-screener](/examples/resume-screener) · [seo-content-brief](/examples/seo-content-brief) · [social-repurpose](/examples/social-repurpose) · [standup-digest](/examples/standup-digest) · [support-triage](/examples/support-triage) · [transcript-shownotes](/examples/transcript-shownotes) |
...
| [sovereign local model](/concepts/providers) | [ceo-monday-brief](/examples/ceo-monday-brief) · [competitor-radar](/examples/competitor-radar) · [config-drift-sentinel](/examples/config-drift-sentinel) · [contract-guard](/examples/contract-guard) · [deep-research-brief](/examples/deep-research-brief) · [incident-war-room](/examples/incident-war-room) · [invoice-chaser](/examples/invoice-chaser) · [localization-factory](/examples/localization-factory) · [meeting-actions](/examples/meeting-actions) · [model-bench](/examples/model-bench) · [pr-review-fanout](/examples/pr-review-fanout) · [release-notes](/examples/release-notes) · [release-radar](/examples/release-radar) · [resume-screener](/examples/resume-screener) · [seo-content-brief](/examples/seo-content-brief) · [social-repurpose](/examples/social-repurpose) · [standup-digest](/examples/standup-digest) · [support-triage](/examples/support-triage) · [transcript-shownotes](/examples/transcript-shownotes) |
