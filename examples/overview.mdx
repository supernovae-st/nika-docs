...
| [typed workflow inputs](/reference/yaml-syntax) | [meeting-actions](/examples/meeting-actions) · [contract-guard](/examples/contract-guard) · [model-bench](/examples/model-bench) · [seo-content-brief](/examples/seo-content-brief) · [config-drift-sentinel](/examples/config-drift-sentinel) · [deep-research-brief](/examples/deep-research-brief) · [release-train](/examples/release-train) |
