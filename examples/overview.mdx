...
Every example on these pages is a complete, validated workflow, not a
fragment. The YAML you read here is projected verbatim from
...
suite: JSON Schema, DAG cross-references, CEL resolution, stdlib
surface. If a file is on this page, it parses.
