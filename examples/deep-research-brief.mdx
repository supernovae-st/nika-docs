...
```mermaid
flowchart LR
  plan["plan · fast model · schema"]:::infer --> investigate["investigate · agent · budgets"]:::agent
  investigate --> brief["brief · thinking budget"]:::infer
  brief --> save["save · nika:write"]:::invoke
