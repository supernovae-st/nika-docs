...
{/* showcase:dag-begin og-images.nika */}
```mermaid
flowchart LR
...
To run a file you own, copy the YAML on this page to `og-images.nika`,
then:

```sh
nika check og-images.nika
nika run og-images.nika
ls assets/og/
```
