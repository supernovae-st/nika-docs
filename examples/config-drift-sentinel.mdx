...
const:
  ...
  # Sanctioned config overrides (RFC 7396 merge-patch shape) · a bare
  # literal: the sanction list is the file's own, never caller-supplied.
  approved_overrides: {}             # zero approved drifts until you say otherwise
