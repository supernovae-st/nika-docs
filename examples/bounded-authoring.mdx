...
{/* showcase:begin 18-bounded-batch.nika */}
```yaml 18-bounded-batch.nika
nika: bounded-batch
...
{/* showcase:begin 19-validate-records.nika */}
```yaml 19-validate-records.nika
...
{/* showcase:begin 20-snapshot-diff.nika */}
```yaml 20-snapshot-diff.nika
nika: snapshot-diff
const:
...
{/* showcase:begin 21-deduplicate-records.nika */}
```yaml 21-deduplicate-records.nika
...
{/* showcase:begin 22-project-public-fields.nika */}
```yaml 22-project-public-fields.nika
...
{/* showcase:begin 23-parallel-review.nika */}
```yaml 23-parallel-review.nika
...
{/* showcase:begin 24-recover-optional-file.nika */}
```yaml 24-recover-optional-file.nika
...
{/* showcase:begin 25-aggregate-by-key.nika */}
```yaml 25-aggregate-by-key.nika
