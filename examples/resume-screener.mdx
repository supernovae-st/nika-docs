...
{/* showcase:dag-begin resume-screener.nika */}
```mermaid
flowchart TD
...
{/* showcase:begin resume-screener.nika */}
```yaml resume-screener.nika
...
<Steps>
  <Step title="Sovereignty is the requirement, not a preference">
    `model: ollama/qwen3.5:4b` at the envelope: candidate data never
