...
permits:
  exec: ["git"]                   # the pulse · argv[0] only
  net:
    http: ["hn.algolia.com"]
  fs:
    read: ["./finance/kpis.csv"]
    write: ["./briefs/**"]        # the filename is dated · the tree is the boundary
  tools: ["nika:convert", "nika:date", "nika:emit", "nika:fetch", "nika:inspect", "nika:jq", "nika:notify", "nika:read", "nika:write"]
