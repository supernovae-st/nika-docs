...
{/* showcase:dag-begin csv-chart-report.nika */}
```mermaid
flowchart LR
...
{/* showcase:begin csv-chart-report.nika */}
```yaml csv-chart-report.nika
...
```bash
nika try csv-chart-report
```

To run a file you own, copy the YAML on this page to
`csv-chart-report.nika`, then:

```bash
nika check csv-chart-report.nika
nika run csv-chart-report.nika
