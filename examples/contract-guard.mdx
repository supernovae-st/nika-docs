...
```mermaid
flowchart LR
  contract["contract · nika:read"]:::invoke --> clauses["clauses · local model"]:::infer
  clauses --> check["check · nika:validate"]:::invoke
  check --> gate["gate · nika:assert"]:::invoke
  clauses --> memo["memo"]:::infer
  gate --> memo
  memo --> save["save · nika:write"]:::invoke
...
{/* showcase:begin t2-contract-guard.nika.yaml */}
```yaml t2-contract-guard.nika.yaml
nika: v1
