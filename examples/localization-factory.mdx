...
```mermaid
flowchart LR
  files["files · nika:glob"]:::invoke --> texts["texts · for_each read"]:::invoke
  files --> pairs["pairs · jq transpose"]:::invoke
  texts --> pairs
  pairs --> translated["translated · for_each ×N"]:::infer
  pairs --> bundle["bundle · jq transpose"]:::invoke
  translated --> bundle
  bundle --> mirror["mirror · for_each write"]:::invoke
...
<Steps>
  ...
  <Step title="The mirror writes itself">
