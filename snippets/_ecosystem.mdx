...
export const Ecosystem = () => (
  <CardGroup cols={3}>
    ...
    <Card title="TypeScript SDK" icon="cube" href="https://github.com/supernovae-st/nika-client">
      `nika-client` — drive workflows from TS/JS.
    </Card>
    <Card title="Homebrew tap" icon="beer-mug-empty" href="https://github.com/supernovae-st/homebrew-tap">
      `brew install supernovae-st/tap/nika` once the binary ships.
    </Card>
