...
| **Every surface at once** | `scripts/update-mirrors.sh` in a [nika-agents](https://github.com/supernovae-st/nika-agents) checkout | `--check` reports drift read-only (CI-able) |
