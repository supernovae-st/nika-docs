...
|---|---|---|
| **VS Code** | extension on the [Marketplace](https://marketplace.visualstudio.com/items?itemName=supernovae.nika) (LSP · DAG canvas · preflight) | [MCP clients → VS Code](/integrations/mcp-clients#vs-code--copilot) |
...
| **goose · Cline · Gemini CLI · Continue · Aider** | generic MCP stanza + `AGENTS.md` (written by `nika init`) | [MCP clients](/integrations/mcp-clients) |
...
| Per-client wiring (12 clients) | [MCP clients](/integrations/mcp-clients) |
...
- [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=supernovae.nika) · [OpenVSX](https://open-vsx.org/extension/supernovae/nika) — the extension
