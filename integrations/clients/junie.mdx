...
description: "Add the read-only Nika oracle to JetBrains Junie via project-scope .junie/mcp/mcp.json."
sidebarTitle: "Junie"
icon: "atom"
---
...
`nika wire junie` writes exactly this — idempotent, unrelated servers
preserved.
