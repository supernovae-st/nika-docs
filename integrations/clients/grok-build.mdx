...
## What loads (historical capture 2026-08-02 · grok 0.2.117 · nika 0.107.0; command names below match the current plugin)

- the 4 skills (authoring · debugging · operating · migration)
- the 6 `/nika:*` commands (check · compile · explain · trace · permits · doctor)
