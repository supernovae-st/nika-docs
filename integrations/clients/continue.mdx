...
description: "Drop one file into ~/.continue/mcpServers/ and Continue gets the read-only Nika oracle — your config.yaml untouched."
...
`nika wire continue` writes exactly this file — idempotent, nothing else
in your Continue setup touched.
...
Continue's tool list shows the nine `nika_*` tools
