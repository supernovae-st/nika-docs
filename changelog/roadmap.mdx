...
| Since | The 0.9x train: agent wiring (0.92) · resume + test harness (0.93) · media suite (0.94) · local-first catalog (0.95) · time-travel debugging (0.96) · hash-chained evidence (0.97) · native structured output + the shared `${{ }}` lexer (0.98). |
