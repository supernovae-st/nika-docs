---
title: "Roadmap"
description: "Forever-v0.x. No v1.0 target. Quality over speed. v0.81 seams → v0.90 foundation → v0.95 memory subsystem → v0.100 ecosystem."
...
<AccordionGroup>
  ...
  <Accordion title="v0.95 — Memory subsystem complete" icon="brain">
    **Target state when shipped:**
