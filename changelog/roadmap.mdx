---
title: "Roadmap"
description: "Forever-v0.x. No v1.0 target. Quality over speed. v0.81 seams → v0.90 foundation → v0.95 Nika Memory → v0.100 ecosystem."
...
<AccordionGroup>
  ...
  <Accordion title="v0.95 — Memory Complete (Nika Memory)" icon="brain">
    **Target state when shipped:**
