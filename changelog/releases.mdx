---
title: "Releases"
description: "Every crate admission + every significant engine update. One source of truth — `CHANGELOG.md` on the nika-diamond branch."
...
<Info>
  **Canonical source:** [`CHANGELOG.md`](https://github.com/supernovae-st/nika/blob/nika-diamond/CHANGELOG.md)
  on the `nika-diamond` branch. This page curates milestones; the full
...
1. **Crate admission commits** on `nika-diamond` (e.g., `feat(nika-X): admit to workspace — all 12 gates passed`).
...
<Update label="Unreleased" description="2026-04-17 · Wave 3A + 4A + 4B + Swarm-3 Batch I.b/II">
  ...
  - **Wave 4A reservations** — 5 forward-compat seams for v0.95 Nika Memory
...
<Update label="v0.80.0-alpha.0" description="2026-04-13 · Diamond begins">
  **The beginning.** Orphan branch `nika-diamond` created from scratch.
...
<CardGroup cols={2}>
  <Card title="CHANGELOG.md" icon="github" href="https://github.com/supernovae-st/nika/blob/nika-diamond/CHANGELOG.md">
    Every crate admission, every hygiene vector deploy, every ADR
    promotion. Source of truth on the `nika-diamond` branch.
  </Card>
  <Card title="Commit history" icon="code-commit" href="https://github.com/supernovae-st/nika/commits/nika-diamond">
    Every commit on the `nika-diamond` branch — atomic, bisectable,
    Co-Authored-By Nika 🦋.
  </Card>
  ...
  <Card title="Roadmap" icon="map" href="/changelog/roadmap">
    What's next — v0.81 seams, v0.90 foundation, v0.95 Nika Memory, v0.100 WASM.
  </Card>
</CardGroup>
