...
<Update label="v0.79.3 — exploration ends" description="2026-04-09 · 322k LOC · 31 crates · the context lesson" tags={["origins", "milestone"]}>
  ...
  first commit, the exploration engine is a working 322k-LOC, 31-crate
  ...
  exploration era is preserved as a read-only private archive
  (`brouillon`); nothing ships from it. Diamond reads it, then
...
<Update label="The version storm" description="2026-02 → 2026-03 · v0.3 → v0.21 in fifteen days" tags={["origins"]}>
  ...
  alone counts 2,900+ commits — the month the exploration engine
  became an ecosystem: LSP, security releases, CI/CD, release
  automation.
</Update>

<Update label="The exploration era begins" description="2026-01-01 · the first commit" tags={["origins", "milestone"]}>
  **The first commit lands on New Year's Day 2026**: `initial nika v0.1
  ...
  one. ~4,600 commits follow in fourteen weeks.
</Update>
