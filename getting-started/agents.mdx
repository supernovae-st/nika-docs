...
Any other MCP client (Zed, opencode, Gemini CLI, Cline, Continue…) takes
the same stanza in its own config: a stdio server, `command: nika`,
`args: ["mcp"]`. The oracle is client-agnostic.
