...
It is the zero-risk first contact: a canonical example rehearsed under
`mock/echo`, nothing written, nothing owned, done in a second. Bare `nika
try` lists the rest of the shelf. `nika init` scaffolds repo-local schema
