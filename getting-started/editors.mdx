---
title: "Editor setup"
description: "What IDE integration ships today and what's planned. Schema validation via yaml-language-server works now; the VS Code extension + LSP ride the v0.81 ship."
...
**(2)** a custom `nika-lsp` server (with the v0.81 ladder) with cross-task binding
...
## Tier 2 — `nika-lsp` custom server (v0.81 ladder · 19.6/19.7)
