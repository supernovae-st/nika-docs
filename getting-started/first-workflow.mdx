...
description: "Preview of the target first-workflow experience. Five minutes from install to a workflow that talks to Claude (v0.81 · the first usable ship · summer 2026)."
