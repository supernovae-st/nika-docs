...
```
▶ greet  infer  → anthropic/claude-sonnet-4-6
  ┌─ output ──────────────────
...
flowchart LR
    ...
    G["greet<br/>infer"]:::task --> F["followup<br/>infer"]:::task
```
...
<CardGroup cols={2}>
  <Card title="Examples · 16 real jobs" icon="rocket" href="/examples/overview">
