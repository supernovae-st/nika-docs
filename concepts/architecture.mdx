---
title: "Architecture"
description: "Nika is a single Rust binary composed of 42 crates (locked target) across 7 layers. Strict downward dependencies, enforced by cargo-deny."
...
**{STATUS.cratesTarget} crates** across seven layers
(L0 · L0.5 · L1 · L2 · L3 · L4 · L5). Each crate has one job.
