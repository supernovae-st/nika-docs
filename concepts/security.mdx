...
| Error | Defense layer |
|---|---|
| `NIKA-380` | dangerous tool invoked on untrusted data → blocked |
| `NIKA-381` | strict-mode trust-level violation |
| `NIKA-382` | exfiltration canary token found in output |
| `NIKA-383` | prompt-injection scanner (+ ML detection) |
| `NIKA-384` | untrusted data reached a prompt without spotlight wrapping |
| `NIKA-386` / `NIKA-387` | workflow recursion depth / cycle blocked |
