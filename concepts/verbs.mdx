...
Save the [canonical file](https://github.com/supernovae-st/nika-spec/blob/main/examples/snippets/run.nika.yaml)
as `run.nika.yaml`, then execute it. It needs no Cargo project or Rust toolchain:

```bash
nika run run.nika.yaml
```
...
[canonical argv example](https://github.com/supernovae-st/nika-spec/blob/main/examples/snippets/run.nika.yaml).
...
save the [complete pipeline](https://github.com/supernovae-st/nika-spec/blob/main/examples/03-exec-pipeline.nika.yaml)
as `exec-pipeline.nika.yaml` and run `nika run exec-pipeline.nika.yaml`.
