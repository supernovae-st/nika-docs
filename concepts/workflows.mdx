---
title: "Workflows"
description: "A .nika file: schema · metadata · tasks. Parsed into a DAG, executed with structured concurrency."
...
```bash
nika run brief-with-stats.nika --var topic="local-first AI"
```
...
```bash
nika run research-brief.nika --var topic="local-first AI" --var bullets=5
```
...
```text
$ nika run research-brief.nika --var topic=x --var oops=1
