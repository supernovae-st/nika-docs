...
|---|---|---|
| `workflow` | Required | Repo-relative `*.nika` path |
...
that the beat is inactive, why, and until when — pick a real date; a past
`jusqu_au` leaves the beat suspended with no explanation anyone believes.
