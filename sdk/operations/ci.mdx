...
<Warning>
  The `0.116.0` source contract is ready, but npm currently serves `0.115.0`.
  Keep this example gated until `npm view @supernovae-st/nika-client version`
  reports `0.116.0`; do not claim an unpublished package is pinned in CI.
</Warning>
