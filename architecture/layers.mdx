...
- **v0.95 Cortex** memory crates — 1 L2 orchestrator (`nika-memory`) + 8 L1 satellites (hnsw, bm25, rrf, fsrs, rdfs-reasoner, temporal, graph-algos, autodesc). No renumber — they slot into L1 / L2 naturally.
