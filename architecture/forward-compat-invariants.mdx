...
v0.90 must accommodate v0.95 (Cortex, agent-v2), v0.100 (WASM plugins, observability),
...
<AccordionGroup>
  <Accordion title="FCI-001 — Kernel traits upfront, implementations deferred" icon="key">
    ...
    **Impact:** v0.95 ships Cortex by adding `nika-memory-oxigraph` that implements
