...
<AccordionGroup>
  <Accordion title="Meta / Process (5)" icon="gavel">
    ...
    | [ADR-002](https://github.com/supernovae-st/nika/blob/main/docs/adr/adr-002-forever-v0x.md) | Real semver toward 1.0 — 0.90.0 release-candidate, 1.0 public API lock when gates are green | 🔄 amended (D-2026-06-20-N1) |
